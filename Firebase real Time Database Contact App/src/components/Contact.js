...
const Contact = ({ contact, contactKey }) => {
  ...
  const deleteContact = () => {
    ...
    firebase.database()
    .ref(`/contacts/${contactKey}`)   //every single component is comprised of contact and contactKey
    .remove()           //when anything is updated in DB u always get a reply from DB back. If success handle these in then and unsuccess in catch
    .then( () => {
