...
const Contacts = () => {
  ...
  const AddContact = () => {
    ...
    //if a user navigates to url and tries to update the details, instead of him doing this we should not allow him to change the values
  ...
  return (
    <Container className="mt-4">
      ...
      {
        contacts.length === 0 && !isLoading ? (  //length is zero and isLoading is false then
